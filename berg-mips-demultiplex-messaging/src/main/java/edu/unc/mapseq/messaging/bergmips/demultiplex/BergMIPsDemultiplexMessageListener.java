...
public class BergMIPsDemultiplexMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsDemultiplexMessageListener.class);

    private String studyName;

    public BergMIPsDemultiplexMessageListener() {
        super();
    }
