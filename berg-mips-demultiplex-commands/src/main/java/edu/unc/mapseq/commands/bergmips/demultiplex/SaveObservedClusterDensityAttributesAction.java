package edu.unc.mapseq.commands.bergmips.demultiplex;
...
@Command(scope = "bergmips-demultiplex", name = "save-observed-cluster-density-attribute", description = "Save Observed Cluster Density Attribute")
@Service
