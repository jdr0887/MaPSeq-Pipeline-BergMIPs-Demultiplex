...
import edu.unc.mapseq.workflow.bergmips.demultiplex.BergMIPsDemultiplexWorkflow;

public class BergMIPsDemultiplexWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsDemultiplexWorkflowExecutorTask.class);
    ...
    public BergMIPsDemultiplexWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    BergMIPsDemultiplexWorkflow casavaWorkflow = new BergMIPsDemultiplexWorkflow();
                    attempt.setVersion(version);
                    attempt.setDequeued(new Date());
                    mapseqDAOBeanService.getWorkflowRunAttemptDAO().save(attempt);
